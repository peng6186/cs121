...
public class LogJson {
  ...
  private LogJson(List<List<String>> entries) { this.entries = entries; } // okay

  public LogJson(Log log) { // okay
  ...
  public static void registerEvent(Class<?> c, String k) { // okay
